...
tutoriallinks: /line/,Rescue Line,c||/line/tiles,Tiles and Turns,a||/line/obstacles,Obstacles,-||/line/spill,Chemical Spill,-||/line/competition,At the Competition,-||/line/logbooks,Sample Logbooks,-||/line/robot-design,Robot Design,-

## Tiles
<img src="{attach}small.jpg" style="width:100%;max-width:500px">
<img src="{attach}large.jpg" style="width:100%;max-width:500px">
...
<img src="{attach}green.jpg" style="width:100%;max-width:140px">
<img src="{attach}gridlock.jpg" style="width:100%;max-width:140px">
...
* There are many other tiles - see these PDFs:
    * [600 x 600 tiles]({attach}600x600.pdf)
    * [300 x 300 tiles]({attach}300x300.pdf)
...
## Colours
* While all tiles and boards are black line on white background, this may change in the future and may be inversed. Make sure you can change your code to deal with this.
...
* Using black electrical tape, create sharp turns (we do not own 300 x 300mm tiles).
